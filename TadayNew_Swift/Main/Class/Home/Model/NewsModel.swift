...
struct NewsModel: HandyJSON {
    ...
    var imageCellHeight: CGFloat {
        ...
        let imageHeight = SCREEN_WIDTH * 9.0 / 16.0 + titleH
        return imageHeight + 50
    }
    
    var girlCellHeight: CGFloat {
        return contentH + 75 + SCREEN_WIDTH * 1.4
    }
    ...
    var ppmmCellHeight: CGFloat { return contentH + 75 + SCREEN_WIDTH * 1.4 }
    var content = ""
    ...
    var contentH: CGFloat { return content.textHeight(fontSize: 16, width: SCREEN_WIDTH - 30) }
    var item_id: Int = 0
    var cell_flag: Int = 0
    ...
    var titleH: CGFloat {
        if video_duration != 0 && video_style == 0 { // // 右侧有图
            return title.textHeight(fontSize: 17, width: SCREEN_WIDTH * 0.72 - 30)
        } else {
            return title.textHeight(fontSize: 17, width: SCREEN_WIDTH - 30)
        }
    }
    
    var videoTitleH: CGFloat { return title.textHeight(fontSize: 16, width: SCREEN_WIDTH - 60) }
    ...
    var appleid = ""
    var description = ""
    var descriptionH: CGFloat { return description.textHeight(fontSize: 13, width: SCREEN_WIDTH - 30) }
